...
function Neo4jD3(_selector, _options) {
    ...
    function appendNode() {
        ...
        return node.enter()
                   ...
                   .attr('class', function(d) {
                       var highlight, i,
                           classes = 'node',
                           label = d.properties['entity_type'];
    ...
    function appendOutlineToNode(node) {
        // const label = node.properties['entity_type'];
        // console.log(node);
        return node.append('circle')
            ...
            .style('fill', function(d) {
                return options.nodeOutlineFillColor ? options.nodeOutlineFillColor : class2color(d.properties['entity_type']);
            })
            .style('stroke', function(d) {
                return options.nodeOutlineFillColor ? class2darkenColor(options.nodeOutlineFillColor) : class2darkenColor(d.properties['entity_type']);
            })
...
//            color = options.colors[Math.min(numClasses, options.colors.length - 1)];
    ...
    function icon(d) {
        var code;
        var label = d.properties['entity_type']
...
*/
    ...
    function toString(d) {
        var s = d.properties['entity_type'] 
    ...
    function updateInfo(d) {
        ...
        if (d.labels) {
            appendInfoElementClass('class', d.properties['entity_type']);
        } else {
...
//        smoothTransform(svgTranslate, svgScale);
      ...
      /**
   * Push arr2 to arr1 avoid duplicate of id
   * @param {*} arr1 
   * @param {*} arr2 
   */
  function arrayPush(arr1, arr2){
    ...
    // remove non-visted values, helping to delete some elements that do not exist anymore 
