  ...
  readNextMessage() {
    ...
    this.readBuffer(4, (lengthReadError, lengthBuffer) => {
      ...
      this.readBuffer(length, (messageError, messageBuffer) => {
        ...
        // const fixedJsonString = messageString.replace(/\n/g, "\\n");// replace line break with escape sequence added by Yamei-tu
        // const fixedJsonString = messageString.replace(/^\s+|\s+$/g, '');
        const message = JSON.parse(messageString.trim(), _serializer.reviver);
